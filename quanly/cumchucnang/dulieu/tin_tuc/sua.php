			...
			<td>
				...
				<?php
					switch($_GET['ts'])
					{
						...
						break;
						default:
							$link_dong="?thamso=quan_ly_tin_tuc&tu_khoa=$_GET[tu_khoa]&trang=$_GET[trang]";
					}
				?>
					...
					<table style="margin:6px 6px 6px 6px;width:954px" id="er_1">
						...
						<tr>
							...
							<td>
								...
								<img src="../hinhanh_flash/tin_tuc/<?php echo $tv_2['hinh_anh'];?>" width="130px" height="100px" style="margin:6px 6px 6px 6px">
