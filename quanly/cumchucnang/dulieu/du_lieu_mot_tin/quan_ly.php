...
<?php
	...
	$chuoi="select * from du_lieu_mot_tin order by id limit $vtbd,$so_gioi_han";
	//echo $chuoi."<hr>";
...
<table width="968px" style="text-align:left;margin-top:6px" id="er">
	...
	<?php
		while($tv_2=mysql_fetch_array($tv_1))
		{
			$link_hinh="../hinhanh_flash/dungchung/no-image-large.png";
			$noi_dung_ngan=cat_chuoi_789(thay_the_fckeditor($tv_2['noi_dung']),0,150);
			$link_sua="?thamso=sua_du_lieu_mot_tin&id=$tv_2[id]&id_menu=$_GET[id]&trang=$_GET[trang]";
			...
			?>
				<tr>
					...
					<td width="100px" align="left">
						<a href="<?php echo $link_sua; ?>" class="thua__link_1"><?php echo $tv_2['ten_menu']; ?></a>
