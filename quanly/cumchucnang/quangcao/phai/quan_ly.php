...
<?php
	...
	$b_tv="select count(*) from quangcao where vitri_quangcao='phai'";
	$b_tv_1=mysql_query($b_tv);
	$b_tv_2=mysql_fetch_array($b_tv_1);
	$st=ceil($b_tv_2[0]/$so_gioi_han);
	$chuoi="select * from quangcao where vitri_quangcao='phai' order by id desc limit $vtbd,$so_gioi_han";
	//echo $chuoi."<hr>";
	$tv_1=mysql_query($chuoi);
?>
<center>

<table width="968px" style="text-align:left;margin-top:6px;color:#666666" id="er">
	<tr>
		<td width="255px" align="center">Hình ảnh/flash</td>
		<td width="290px">Liên kết</td>
						...
						<?php
							...
							?>
									<a href="<?php echo $link_sua; ?>">
										<img src="<?php echo $link_file;?>" style="width:<?php echo $rong; ?>;height:<?php echo $cao; ?>">
									</a>
							<?php
								}
								else
