...
<center>
	<table width="968px" id="er" style="text-align:left;margin:6px 0px 6px 0px;font-size:16px;color:#666666">
		...
		<?php
			...
			{
					$link_xem="?thamso=xem_hoa_don&id=$tv_2[id]&trang=$_GET[trang]";
					$link_xoa="?thamso=xoa_hoa_don&id=$tv_2[id]&trang=$_GET[trang]";
				?>
					<tr>
