...
<?php
	...
	$noi_dung=thay_the_fckeditor($tv_2['gia_tri']);
	...
	$a_tv="select * from lien_he where id='1'";
			...
			<td>
				<form action="" method="post" enctype="multipart/form-data">
					<table style="margin:6px 6px 6px 6px;width:954px" id="er_1">
						<tr>
							<td width="120px"><b>Email liên hệ :</b></td>
							<td><input style="width:300px" name="email" value="<?php echo $a_tv_2['gia_tri']; ?>"></td>
						</tr>
						<tr>
							<td colspan="2">
								<center>
						...
						<tr>
							<td colspan="2">
								<center>
									<input type="hidden" name="thaydoi_lienhe" value="thaydoi_lienhe">
